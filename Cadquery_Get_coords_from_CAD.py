...
with open(f'{output_dir}/VX4_Front_1_Blade-span_{dist_spanwise}-sec_{dist_airfoil}{TE_property}.pmt', 'w') as file:
...
with open(f'{output_dir}/Blade_points_check{TE_property}.txt', 'w') as file:
